...
const I18N_DATA = {
    ...
    'bat.title':'The Bat Islands & their bull sharks',
    'bat.lead':'A UNESCO-protected reserve off Santa Rosa National Park, one of the few places on Earth with regular, unbaited bull shark encounters.',
    ...
    'charters.intro':'Salty Horizon has partnered with Playgrounds, a private 51-foot catamaran based in Tamarindo, to open up a bigger stretch of ocean: diving, snorkeling, whale watching and sunset, all in one tailor-made day at sea.',
    'charters.partnerLinkTop':'Discover the Playgrounds catamaran ↗',
    'charters.spec1':'Catamaran','charters.spec2':'Guests aboard','charters.spec3':'Private cabins','charters.spec4':'Cruising speed',
    'charters.whale.eyebrow':'Whale season · Jul–Nov',
    'charters.whale.t':'Whale season, from the water',
    'charters.whale.d':'From July to November, humpback whales migrate along this stretch of the Guanacaste coast to breed and calve, one of the longest migrations recorded for the species. From the flybridge of Playgrounds you get a front-row seat above the water, with the chance to slip in for a snorkel alongside dolphins riding the bow wave. Sightings are never guaranteed, wild animals keep their own schedule, but this is the season to be out there looking.',
    'charters.partner.eyebrow':'In partnership with Playgrounds',
    'charters.partner.t':'A 51-foot playground, all to yourselves',
    'charters.partner.d':'Playgrounds is a private power catamaran based right here in Tamarindo: three cabins, three bathrooms, a wide aft cockpit and an open flybridge built for lounging in the sun. Captain Pete has navigated these waters for more than 15 years, and his crew takes care of everything on board, so the only decision left is where to point the bow.',
    'charters.partner.link':'Explore the Playgrounds catamaran ↗',
    'charters.onboard.eyebrow':'Onboard',
    'charters.onboard.t':'One boat, every kind of day',
    'charters.onboard.lead':'Mix and match everything Playgrounds has to offer, your itinerary, your pace.',
    ...
    'charters.f4t':'Whale & dolphin watching','charters.f4d':'Humpback whales pass through from July to November; dolphins can turn up any time of year.',
    'charters.f5t':'Sport fishing','charters.f5d':"Troll for yellowfin tuna, sailfish and dorado with Captain Pete's local know-how.",
    'charters.f6t':'Sunset cruise','charters.f6d':'End the day adrift with a cocktail in hand as the sky turns gold over the Pacific.',
