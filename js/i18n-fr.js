...
const I18N_DATA = {
    ...
    'charters.h1':'Une journée en mer, entièrement à vous',
    'charters.lead':'Votre journée en mer, exactement comme vous la voulez.',
    'charters.intro':"Salty Horizon s'est associé à Playgrounds, un catamaran privé de 51 pieds basé à Tamarindo, pour ouvrir un plus grand terrain de jeu en mer : plongée, snorkeling, observation des baleines et coucher de soleil, le tout en une seule journée sur mesure.",
    'charters.partnerLinkTop':'Découvrir le catamaran Playgrounds ↗',
    'charters.spec1':'Catamaran','charters.spec2':'Invités à bord','charters.spec3':'Cabines privées','charters.spec4':'Vitesse de croisière',
    'charters.whale.eyebrow':'Saison des baleines · Juil.–Nov.',
    'charters.whale.t':"La saison des baleines, vue de l'eau",
    'charters.whale.d':"De juillet à novembre, les baleines à bosse migrent le long de cette portion de la côte du Guanacaste pour se reproduire et mettre bas, l'une des plus longues migrations connues pour cette espèce. Depuis le flybridge de Playgrounds, vous avez une vue imprenable au-dessus de l'eau, avec la possibilité de plonger pour un snorkeling aux côtés des dauphins qui surfent sur la vague d'étrave. Les observations ne sont jamais garanties, les animaux sauvages suivent leur propre calendrier, mais c'est la saison pour être en mer et ouvrir l'œil.",
    'charters.partner.eyebrow':'En partenariat avec Playgrounds',
    'charters.partner.t':'Un terrain de jeu de 51 pieds, rien que pour vous',
    'charters.partner.d':"Playgrounds est un catamaran à moteur privé basé ici même à Tamarindo : trois cabines, trois salles de bain, un vaste cockpit arrière et un flybridge ouvert conçu pour se prélasser au soleil. Le capitaine Pete navigue dans ces eaux depuis plus de 15 ans, et son équipage s'occupe de tout à bord, il ne vous reste plus qu'à décider où mettre le cap.",
    'charters.partner.link':'Découvrir le catamaran Playgrounds ↗',
    'charters.onboard.eyebrow':'À bord',
    'charters.onboard.t':'Un bateau, toutes les envies',
    'charters.onboard.lead':'Combinez tout ce que Playgrounds a à offrir, selon votre itinéraire, à votre rythme.',
    ...
    'charters.f4t':'Baleines & dauphins','charters.f4d':"Les baleines à bosse passent de juillet à novembre ; les dauphins peuvent se montrer toute l'année.",
    'charters.f5t':'Pêche sportive','charters.f5d':'Traquez thon jaune, voilier et dorado grâce à l’expérience locale du capitaine Pete.',
    'charters.f6t':'Croisière au coucher du soleil','charters.f6d':"Terminez la journée à la dérive, cocktail à la main, tandis que le ciel s'embrase sur le Pacifique.",
