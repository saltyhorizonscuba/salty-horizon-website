...
const I18N_DATA = {
    ...
    'camille.specLabel':'Especialidades',
    'camille.spec':'AWARE Shark Conservation, Deep, Digital Underwater Photography, Dive Against Debris, Nitrox, Wreck, AWARE Coral Reef Conservation, PADI AWARE, Peak Performance Buoyancy, EFR',
    ...
    'julien.specLabel':'Especialidades',
    'julien.spec':'AWARE Coral Reef Conservation Instructor, Dive Against Debris, Emergency Oxygen Provider Instructor, Nitrox, PADI AWARE, Peak Performance Buoyancy Instructor',
    ...
    'exp.page.badge1':'Instructores certificados PADI','exp.page.badge2':'12+ años de experiencia en buceo','exp.page.badge3':'Equipo local en Tamarindo','exp.page.badge4':'Trilingüe: EN · FR · ES','exp.page.badge5':'Reseñas de 5 estrellas','exp.page.badge6':'Guía privada',
    ...
    'charters.h1':'Un día en el mar, completamente tuyo',
    'charters.lead':'Tu día en el mar, exactamente como lo quieres.',
    'charters.intro':'Salty Horizon se ha asociado con Playgrounds, un catamarán privado de 51 pies con base en Tamarindo, para abrir un terreno de juego más grande en el mar: buceo, snorkel, avistamiento de ballenas y atardecer, todo en un solo día a medida.',
    'charters.partnerLinkTop':'Descubre el catamarán Playgrounds ↗',
    'charters.spec1':'Catamarán','charters.spec2':'Invitados a bordo','charters.spec3':'Camarotes privados','charters.spec4':'Velocidad de crucero',
    'charters.whale.eyebrow':'Temporada de ballenas · Jul.–Nov.',
    'charters.whale.t':'Temporada de ballenas, desde el agua',
    'charters.whale.d':'De julio a noviembre, las ballenas jorobadas migran a lo largo de este tramo de la costa de Guanacaste para reproducirse y parir, una de las migraciones más largas registradas para la especie. Desde el flybridge de Playgrounds tienes un asiento en primera fila sobre el agua, con la posibilidad de meterte a hacer snorkel junto a delfines que surfean la ola de proa. Los avistamientos nunca están garantizados, los animales salvajes siguen su propio calendario, pero esta es la temporada para estar ahí afuera buscando.',
    'charters.partner.eyebrow':'En alianza con Playgrounds',
    'charters.partner.t':'Un terreno de juego de 51 pies, solo para ustedes',
    'charters.partner.d':'Playgrounds es un catamarán a motor privado con base aquí mismo en Tamarindo: tres camarotes, tres baños, una amplia cabina de popa y un flybridge abierto pensado para relajarse al sol. El capitán Pete navega estas aguas desde hace más de 15 años, y su tripulación se encarga de todo a bordo, así que lo único que queda por decidir es hacia dónde poner la proa.',
    'charters.partner.link':'Descubre el catamarán Playgrounds ↗',
    'charters.onboard.eyebrow':'A bordo',
    'charters.onboard.t':'Un solo barco, todos los planes',
    'charters.onboard.lead':'Combina todo lo que Playgrounds tiene para ofrecer, con tu propio itinerario y a tu ritmo.',
    ...
    'charters.f4t':'Ballenas y delfines','charters.f4d':'Las ballenas jorobadas pasan de julio a noviembre; los delfines pueden aparecer en cualquier época del año.',
    'charters.f5t':'Pesca deportiva','charters.f5d':'Pesca atún aleta amarilla, pez vela y dorado con el conocimiento local del capitán Pete.',
    'charters.f6t':'Crucero al atardecer','charters.f6d':'Termina el día a la deriva, cóctel en mano, mientras el cielo se tiñe de dorado sobre el Pacífico.',
