...
- `index.html` : `SportsActivityLocation` (`@id=#business`, avec `review[]` **et `aggregateRating`** — `ratingValue:5`, `reviewCount:22` (revérifié le 2026-09-09 sur les 3 langues ; était `14` entre le 2026-07-12 et le 2026-08-01, le nombre augmente au fil du temps — voir note section 2), `FAQPage` (5 Q/R), `Person`×2 (`@id=#camille`, `@id=#julien`). *(Correction au tableau du 2026-07-14 : la mention « pas d'`aggregateRating` » qui figurait ici jusqu'au 2026-07-28 était déjà obsolète depuis le 2026-07-12 — corrigée à cette occasion.)*
